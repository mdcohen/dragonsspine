...
{
    [SpellAttribute(GameSpell.GameSpellID.Stranglehold, "stranglehold", "Stranglehold", "Place an unnatural stranglehold on a humanoid target. Likely causes the target to be stunned.",
        Globals.eSpellType.Evocation, Globals.eSpellTargetType.Single, 27, 15, 750000, "0229", false, false, true, false, true, Character.ClassType.Sorcerer)]
    public class StrangleholdSpell : ISpellHandler
    {
