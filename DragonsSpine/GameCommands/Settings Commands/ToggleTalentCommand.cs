...
{
    [CommandAttribute("toggletalent", "Disable or enable use of a passive talent.", (int)Globals.eImpLevel.USER, new string[] { "ttal", "ttalent" },
        0, new string[] { "toggletalent <talent command>" }, Globals.ePlayerState.PLAYING, Globals.ePlayerState.CONFERENCE)]
    public class ToggleTalentCommand : ICommandHandler
    {
