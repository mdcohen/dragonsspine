...
{
    [CommandAttribute("thamuz", "Speaking the name of a demon may be hazardous to your health.",
    ...
    public class ThamuzCommand : ICommandHandler
    {
        public bool OnCommand(Character chr, string args)
        {
            Commands.DemonSummoningChantCommand.ChantDemonSummon(DemonName.Thamuz, chr);
