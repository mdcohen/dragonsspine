...
{
    [CommandAttribute("damballa", "Speaking the name of a demon may be hazardous to your health.",
    ...
    public class DamballaCommand : ICommandHandler
    {
        public bool OnCommand(Character chr, string args)
        {
            Commands.DemonSummoningChantCommand.ChantDemonSummon(DemonName.Damballa, chr);
