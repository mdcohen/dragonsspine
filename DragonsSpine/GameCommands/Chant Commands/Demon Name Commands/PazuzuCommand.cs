...
{
    [CommandAttribute("pazuzu", "Speaking the name of a demon may be hazardous to your health.",
    ...
    public class PazuzuCommand : ICommandHandler
    {
        public bool OnCommand(Character chr, string args)
        {
            Commands.DemonSummoningChantCommand.ChantDemonSummon(DemonName.Pazuzu, chr);
