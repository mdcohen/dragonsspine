...
{
    [CommandAttribute("perdurabo", "Speaking the name of a demon may be hazardous to your health.",
    ...
    public class PerduraboCommand : ICommandHandler
    {
        public bool OnCommand(Character chr, string args)
        {
            Commands.DemonSummoningChantCommand.ChantDemonSummon(DemonName.Perdurabo, chr);
