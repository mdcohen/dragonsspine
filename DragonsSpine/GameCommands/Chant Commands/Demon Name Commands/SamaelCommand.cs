...
{
    [CommandAttribute("samael", "Speaking the name of a demon may be hazardous to your health.",
    ...
    public class SamaelCommand : ICommandHandler
    {
        public bool OnCommand(Character chr, string args)
        {
            Commands.DemonSummoningChantCommand.ChantDemonSummon(DemonName.Samael, chr);
