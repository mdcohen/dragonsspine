...
{
    [CommandAttribute("showsack", "Display a list of sack items.", (int)Globals.eImpLevel.USER, new string[] { "show sack" },
        0, new string[] { "There are no arguments for the show sack command." }, Globals.ePlayerState.PLAYING, Globals.ePlayerState.CONFERENCE)]
    public class ShowSackCommand : ICommandHandler
    {
