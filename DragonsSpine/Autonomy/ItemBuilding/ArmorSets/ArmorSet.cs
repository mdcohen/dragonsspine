...
namespace DragonsSpine.Autonomy.ItemBuilding.ArmorSets
{
    public class ArmorSet
    {
        ...
        /// <summary>
        /// Important, these are in order of durability and armor rating. Lowest to highest.
        /// </summary>
        ...
        public List<int> GetArmorList(NPC npc)
        {
